...
const CONFIGS = {
    ...
    inventory: {
        ...
        previewCols: ['id', 'name', 'type', 'width_cm', 'height_cm', 'stock_quantity', 'unit_cost', 'uom'],
    },
    employees: {
        title: 'Employees',
        ...
        columns: [
            ...
            { key: 'no_pay_type',    label: 'no_pay_type' },
            { key: 'no_pay_value',   label: 'no_pay_value' },
            { key: 'ot_rate',        label: 'ot_rate' },
            { key: 'double_ot_rate', label: 'double_ot_rate' },
            { key: 'late_deduction_rate', label: 'late_deduction_rate' },
            { key: 'notes',         label: 'notes' },
        ],
