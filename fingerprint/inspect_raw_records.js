...
async function inspectRaw() {
  ...
  try {
    ...
    const GET_ATTENDANCE_LOGS = Buffer.from([0x01, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
    
    console.log('Fetching raw logs...');
    const data = await zkInstance.zklibTcp.readWithBuffer(GET_ATTENDANCE_LOGS);
