...
const useCompany2 = process.env.USE_COMPANY_2_DB === 'true';

const dbPool = mysql.createPool({
    host: useCompany2 ? 'gateway01.ap-southeast-1.prod.aws.tidbcloud.com' : process.env.DB_HOST,
    port: useCompany2 ? 4000 : parseInt(process.env.DB_PORT || '4000', 10),
    user: useCompany2 ? '2Db1nUiVftFh5mM.root' : process.env.DB_USERNAME,
    password: useCompany2 ? 'N8QPZ4x1VFYzaUq9' : process.env.DB_PASSWORD,
    database: useCompany2 ? 'erp_press' : process.env.DB_DATABASE,
    ssl: {
        minVersion: 'TLSv1.2',
