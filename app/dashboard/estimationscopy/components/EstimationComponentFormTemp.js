...
export default function EstimationComponentForm({
    ...
    return (
        <section className="bg-black/40 backdrop-blur-md p-6 rounded-xl border border-white/10 relative">
            <div className="absolute hidden top-4 right-4 z-10 flex items-center gap-2">
                <button
            ...
            <div className="mb-4 border-b border-white/10 pb-4">
                <div className="flex justify-between items-center mb-2">
                    <h3 className="text-md font-semibold text-gray-300">{data.name}</h3>
                    <div className=" hidden bg-black/50 rounded-lg p-1 border mr-10 border-white/10">
                        <button
                ...
                <div className="hidden md:grid-cols-2 gap-4 mb-2">
            ...
            <div className="flex gap-4 mb-5">
                <div className="bg-gradient-to-b from-white/[0.07] to-transparent backdrop-blur-lg p-5 rounded-2xl border border-white/10 w-64 flex flex-col gap-4 mb-4 shadow-2xl">
                    <div className="flex justify-between items-center w-full">
                        <span className="text-xs font-medium text-gray-400 tracking-wide">Operation Asset</span>
                        <div className="p-1.5 rounded-md bg-white/5 text-gray-300">
                            <RiPrinterFill className="text-lg" />
                        </div>
                    </div>
                    <div>
                        <h4 className="text-2xl font-semibold text-white tracking-tight truncate" title={machines.find(m => m.id == params.machineId)?.name}>
                            {params.machineId ? machines.find(m => m.id == params.machineId)?.name : 'None'}
                        </h4>
                        <p className="text-[11px] text-emerald-400 font-mono mt-1 flex items-center gap-1">
                            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 inline-block animate-pulse"></span> Active Standard
                        </p>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    {type === 'offset' && data.name !== "Finishing" &&(
                        <div className="grid md:grid-cols-3 gap-4 mb-6">
                            ...
                            <div><label className="block text-sm text-gray-400 mb-1">Pages</label><Input disabled={data.name === "Cover"} type="number" name="pages" value={data.name === "Cover" ? params.sides : params.pages} onChange={handleChange} className="bg-secondary border-white/10" /></div>
                            <div className='hidden'><label className="block text-sm text-gray-400 mb-1">Ups</label><Input type="number" name="ups" value={params.ups} onChange={handleChange} className="bg-secondary border-white/10" /></div>
                            <div className='hidden'>
                            ...
                            <div className='hidden'><label className="block text-sm text-gray-400 mb-1">Colors</label><Input type="number" name="colors" value={params.colors} onChange={handleChange} className="bg-secondary border-white/10" /></div>
                    ...
                    {type === 'digital' && data.name !== "Finishing" && (
                        <>
                            ...
                            <div className="grid md:grid-cols-2 gap-4 mb-6">
                                ...
                                <div className='hidden'><label className="block text-sm text-gray-400 mb-1">Paper Cost/Sheet</label><Input type="number" name="paperCostPerSheet" value={params.paperCostPerSheet} onChange={handleChange} className="bg-secondary border-white/10" /></div>
                                <div className='hidden'><label className="block text-sm text-gray-400 mb-1">Print Cost / sq(cm)</label><Input type="number" name="digitalPricePerSqCm" value={params.digitalPricePerSqCm} onChange={handleChange} className="bg-secondary border-white/10 disabled:opacity-50" disabled /></div>
                                <div>
                    ...
                    {type === 'offset' && data.name !== "Finishing" && (
                        <>
                            ...
                            <div className="grid md:grid-cols-3 gap-4 mb-6">
                                ...
                                <div className='hidden'><label className="block text-sm text-gray-400 mb-1">Paper Cost/Sheet</label><Input type="number" name="paperCostPerSheet" value={params.paperCostPerSheet} onChange={handleChange} className="bg-secondary border-white/10" /></div>
                                <div className='hidden'><label className="block text-sm text-gray-400 mb-1">Plate Cost/Unit</label><Input type="number" name="plateCostPerUnit" value={params.plateCostPerUnit} onChange={handleChange} className="bg-secondary border-white/10" /></div>
                                <div className='hidden'><label className="block text-sm text-gray-400 mb-1">Impression Cost</label><Input type="number" name="impressionCostPerUnit" value={params.impressionCostPerUnit} onChange={handleChange} className="bg-secondary border-white/10" /></div>
                                ...
                                <div><label className="block text-sm text-gray-400 mb-1">Bleed (mm)</label><Input type="number" name="bleedMm" value={params.bleedMm || ''} onChange={handleChange} min={0.1} className="bg-secondary border-white/10" /></div>
                            </div>
                        </>
                    )}
                    {type === 'digital' && (
                    ...
                    <div>
                        <h3 className={data.name === "Finishing" ? "hidden" : "text-md font-semibold text-gray-300 mb-3 border-t border-white/10 pt-4"}>Finishings</h3>
