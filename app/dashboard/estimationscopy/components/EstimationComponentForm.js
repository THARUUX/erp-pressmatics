...
export default function EstimationComponentForm({
    ...
    const handleChange = (e) => {
        ...
        if (name === 'size') {
            const size = value;
            switch (size) {
                case 'A1': newParams.compWidthCm = 84.1; newParams.compHeightCm = 59.4; break;
                case 'A2': newParams.compWidthCm = 59.4; newParams.compHeightCm = 42; break;
                case 'A3': newParams.compWidthCm = 29.7; newParams.compHeightCm = 42; break;
                case 'A4': newParams.compWidthCm = 21; newParams.compHeightCm = 29.7; break;
                case 'A5': newParams.compWidthCm = 14.8; newParams.compHeightCm = 21; break;
                case 'A6': newParams.compWidthCm = 10.5; newParams.compHeightCm = 14.8; break;
            }
        }
