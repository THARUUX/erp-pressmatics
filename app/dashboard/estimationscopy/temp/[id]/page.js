...
import EstimationComponentForm from '../../components/EstimationComponentFormTemp';
            ...
            try {
                ...
                const mappedComps = fetchedComponents.map(comp => ({
                    ...
                    params: {
                        ...
                        bleedMm: comp.bleed_mm != null ? comp.bleed_mm : 3.0,
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6 border-b border-white/10 pb-3">
                            ...
                            >
                                ...
                                {components.length > 1 && (
                                    <span
                                        ...
                                        className="text-gray-400 hidden hover:text-red-400 transition-colors ml-1 text-xs px-1"
                        ...
                        <button
                            ...
                            className="px-4 py-2 hidden rounded-lg text-sm font-medium bg-transparent border border-dashed border-white/20 text-gray-400 hover:border-white/40 hover:text-white transition-all flex items-center gap-1.5"
                        >
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="sticky top-8 space-y-4">
                        ...
                        {components[activeTab].type === 'offset' && (
                            <section className="bg-black/60 backdrop-blur-xl p-6 rounded-xl border border-white/20 shadow-2xl">
                                <h3 className="text-md font-bold mb-4 text-gray-300 flex justify-between">
