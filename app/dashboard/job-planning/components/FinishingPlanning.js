                        ...
                        <ContextMenu.Portal>
                            ...
                            >
                                ...
                                {finishings.map(fin => (
                                    <ContextMenu.Item
                                        key={fin.id}
                                        onClick={() => handleTransfer(fin)}
                                        className="w-full px-2.5 py-1.5 text-left text-xs text-neutral-300 hover:bg-white/10 hover:text-white outline-none truncate block cursor-pointer select-none"
                                    >
                                        {fin.name}
                                    </ContextMenu.Item>
                                ))}
