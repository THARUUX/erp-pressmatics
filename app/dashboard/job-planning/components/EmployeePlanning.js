                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
                    <div>
                        <h3 style={{ color: G.text, fontSize: 16, fontWeight: 700, margin: 0, display: 'flex', alignItems: 'center', gap: 8 }}>
                            <FiPrinter className="text-purple-400" size={18} /> Employee Planning Report
                        </h3>
                            ...
                            {[
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        background: reportType === k ? 'rgba(167,139,250,0.15)' : G.glass,
        ...
        >
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    {task.machine_name && (
                        <span style={{ fontSize: 9, color: G.purple, background: 'rgba(167,139,250,0.1)', padding: '1px 5px', borderRadius: 4 }}>
                            {task.machine_name}
                        </span>
                    )}
                </div>
    ...
    return (
        <div style={{ fontFamily: 'Inter, sans-serif', color: G.text }}>
            ...
            <div style={{
                ...
                marginBottom: 20, flexWrap: 'wrap', background: G.glass,
                border: `1px solid ${G.border}`, borderRadius: 16, padding: '10px 14px'
            }}>
                {/* View switcher */}
                                                            ...
                                                            return (
                                                                <td
                                                                    ...
                                                                    style={{
                                                                        padding: 8, borderRight: `1px solid ${G.border}`,
                                                                        verticalAlign: 'top',
                                                                        background: isOver ? 'rgba(167,139,250,0.1)' : 'transparent',
                                                                ...
                                                                >
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="hover:text-purple-300 hover:border-purple-500/40"
                                                                    >
                                                                        + Add task
                                                                    </button>
                                                                </td>
                                            ...
                                            >
                                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
                                                    ...
                                                    <div style={{ textAlign: 'right' }}>
                                                        <span style={{ fontSize: 11, fontWeight: 700, color: G.purple, background: 'rgba(167,139,250,0.1)', padding: '2px 8px', borderRadius: 6 }}>
                                                            {totalHrs} hrs
                                                        </span>
                                                        <button
                                                            onClick={() => setExportEmployee(emp)}
                                            ...
                                            >
                                                ...
                                                <div style={{ display: 'flex', gap: 8 }}>
                                                    ...
                                                    <button
                                                        ...
                                                        style={{
                                                            flex: 1, padding: '8px 0', background: 'rgba(167,139,250,0.15)',
