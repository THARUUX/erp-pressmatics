                            ...
                            <div className="flex items-center justify-between border-t border-white/5 pt-4 mt-2">
                                ...
                                <button
                                    onClick={() => {
                                        ...
                                        window.open(`/api/job-planning/machine/${selectedMachine.id}/pdf?weekStart=${y}-${m}-${d}&includeDays=${weeklyPrintDays.join(',')}`, '_blank');
                                    }}
                                    className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold rounded-lg transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-950/20 cursor-pointer"
                                >
                                    Download PDF
                                </button>
                            </div>
                                            ...
                                            <>
                                                ...
                                                <button
                                                    onClick={() => {
                                                        ...
                                                        const m = String(activeDate.getMonth() + 1).padStart(2, '0');
                                                        const d = String(activeDate.getDate()).padStart(2, '0');
                                                        window.open(`/api/job-planning/machine/${selectedMachine.id}/pdf?date=${y}-${m}-${d}&checksheet=true`, '_blank');
                                                    }}
                                                    style={{
                                                        display: 'flex', alignItems: 'center', gap: 6,
                                                        padding: '7px 12px', border: `1px solid ${G.border}`, borderRadius: 8,
